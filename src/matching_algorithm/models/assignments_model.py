...
class ConflictModel():
    ...
    def add_teacher_has_more_than_weekly_hours(self, teacher_name: str, weekly_hours: int, assigned_hours: int) -> None:
    ...
    def add_partially_unassigned(self, class_name: str, role: RoleType, assigned: int, needed: int) -> None:
